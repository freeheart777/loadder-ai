...
type AskLoadderProps = { projectId: string; onApplied: (content: Record<string, any>, revision: number) => void; beforePropose?: () => Promise<void> };
