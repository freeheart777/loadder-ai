...
export type MediaSlotKey = "main" | "secondary" | "tertiary";
export type MediaSlot = { imageUrl: string; altText?: string };
export type MediaSlots = Record<MediaSlotKey, MediaSlot>;
export type LayoutDirection = "media-right" | "media-left";
export type LayoutRatio = 50 | 60 | 70 | 80;
export type LayoutHeight = "compact" | "medium" | "large" | "extra-large";
export type HeroLayout =
  ...
  | "background"
  | "minimal";
export type BannerLayout = "full-width" | "two-up" | "main-two" | "image-text" | "text-image";
...
export type HeroConfig = { enabled: boolean; layout: HeroLayout; direction: LayoutDirection; ratio: LayoutRatio; heightPreset: LayoutHeight; eyebrow: string; title: string; subtitle: string; ctaLabel: string; ctaHref: string; secondaryCtaLabel: string; secondaryCtaHref: string; imageUrl: string; mediaSlots: MediaSlots; backgroundColor: string; textColor: string; overlayOpacity: number; height: number; alignment: "right" | "center" | "left" };
...
export type SectionConfig = { id: string; type: "products" | "banner" | "trust" | "text" | "spacer"; enabled: boolean; title: string; subtitle: string; eyebrow?: string; imageUrl?: string; ctaLabel?: string; ctaHref?: string; banner?: BannerLayoutConfig; backgroundColor: string; textColor: string; spacingTop: number; spacingBottom: number; productSettings?: ProductSettings };
