      ...
      <AuthProvider>
        ...
        <Route path="/signup" element={<AuthPage />} />
          ...
          <Route element={<RequireAuth />}>
            ...
            <Route path="/legacy-dashboard" element={internalToolsEnabled ? <HomePage /> : <Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/brand-book" element={<BrandBookPage />} />
            <Route path="/dashboard/business-proposal" element={<Navigate to="/dashboard" replace />} />
            ...
            <Route path="/dashboard/social" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/ads" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/marketing" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/crm" element={<CrmLeadsPage />} />
            ...
            <Route path="/dashboard/crm/customer/:id" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/analytics" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/kpi" element={<Navigate to="/dashboard" replace />} />
            <Route path="/dashboard/predictive" element={<Navigate to="/dashboard" replace />} />
            ...
            <Route path="/click-test" element={internalToolsEnabled ? <ClickTestPage /> : <Navigate to="/dashboard" replace />} />
            <Route path="/intelligence" element={internalToolsEnabled ? <IntelligencePreviewPage /> : <Navigate to="/dashboard" replace />} />
