...
const StoreWebsiteStudioPageV9 = lazy(() => import("./pages/StoreWebsiteStudioPageV9"));
...
export default function App() {
  return <BrowserRouter><AuthProvider><DemoModePreserver /><Suspense fallback={null}><Routes>
    ...
    <Route element={<RequireAuth />}>
      ...
      <Route path="/dashboard/business-brain" element={<BusinessBrainPage />} /><Route path="/dashboard/websites" element={<StoreWebsiteStudioPageV9 />} />
      ...
      <Route path="/dashboard/websites/studio" element={<StoreWebsiteStudioPageV9 />} /><Route path="/dashboard/websites/store-v1" element={<StoreWebsiteStudioPage />} /><Route path="/dashboard/websites/studio-v2" element={<StoreWebsiteStudioPageV2 />} /><Route path="/dashboard/websites/studio-v3" element={<StoreWebsiteStudioPageV3 />} /><Route path="/dashboard/websites/studio-v4" element={<StoreWebsiteStudioPageV4 />} /><Route path="/dashboard/websites/studio-v5" element={<StoreWebsiteStudioPageV5 />} /><Route path="/dashboard/websites/studio-v6" element={<StoreWebsiteStudioPageV6 />} /><Route path="/dashboard/websites/studio-v7" element={<StoreWebsiteStudioPageV7 />} /><Route path="/dashboard/websites/studio-v8" element={<StoreWebsiteStudioPageV8 />} /><Route path="/dashboard/websites/studio-legacy" element={<VisualWebsiteStudioPage />} /><Route path="/dashboard/websites/ai" element={<NativeSiteBuilderPage />} /><Route path="/dashboard/websites/new" element={<StoreWebsiteStudioPageV9 />} /><Route path="/dashboard/site-operations" element={<SiteOperationsDashboardPage />} />
      <Route path="/site-builder" element={<StoreWebsiteStudioPageV9 />} /><Route path="/site-builder/legacy" element={<SiteProjectStudioPage />} /><Route path="/click-test" element={<ClickTestPage />} /><Route path="/intelligence" element={<IntelligencePreviewPage />} />
